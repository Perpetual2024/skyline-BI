import { LiquibaseConfig, CalculateCheckSumCommandAttributes, ChangelogSyncToTagCommandAttributes, ChangelogSyncCommandAttributes, ChangelogSyncToTagSQLCommandAttributes, ChecksBulkSetCommandAttributes, ChecksCopyCommandAttributes, ChecksCreateCommandAttributes, ChecksCustomizeCommandAttributes, ChecksDeleteCommandAttributes, ChecksDisableCommandAttributes, ChecksEnableCommandAttributes, ChecksResetCommandAttributes, ChecksRunCommandAttributes, ChecksShowCommandAttributes, DbDocCommandAttributes, DbclHistoryCommandAttributes, DiffChangelogCommandAttributes, DiffCommandAttributes, ExecuteSqlCommandAttributes, FlowCommandAttributes, FutureRollbackCountSQLCommandAttributes, GenerateChangeLogCommandAttributes, InitCommandAttributes, RollbackCommandAttributes, RollbackSQLCommandAttributes, RollbackCountCommandAttributes, RollbackCountSQLCommandAttributes, RollbackToDateCommandAttributes, RollbackToDateSQLCommandAttributes, RollbackOneChangesetCommandAttributes, RollbackOneChangesetSQLCommandAttributes, RollbackOneUpdateCommandAttributes, RollbackOneUpdateSQLCommandAttributes, SetContextsCommandAttributes, SetLabelsCommandAttributes, SnapshotCommandAttributes, SnapshotReferenceCommandAttributes, SyncHubCommandAttributes, TagCommandAttributes, TagExistsCommandAttributes, UpdateCommandAttributes, UpdateSQLCommandAttributes, UpdateCountCommandAttributes, UpdateCountSQLCommandAttributes, UpdateToTagCommandAttributes, UpdateToTagSQLCommandAttributes, UpdateOneChangesetCommandAttributes, UpdateOneChangesetSQLCommandAttributes } from './models';
import { WithOptionalSubstitutionParams } from './models/commands/substitution-params.model';
export declare class Liquibase {
     ...
     */
    update(params: WithOptionalSubstitutionParams<UpdateCommandAttributes>): Promise<string>;
    /**
    ...
    updateOneChangeset(params: UpdateOneChangesetCommandAttributes): Promise<string>;
    updateOneChangesetSQL(params: UpdateOneChangesetSQLCommandAttributes): Promise<string>;
    /**
    ...
    rollbackOneChangeset(params: RollbackOneChangesetCommandAttributes): Promise<string>;
    rollbackOneChangesetSQL(params: RollbackOneChangesetSQLCommandAttributes): Promise<string>;
    rollbackOneUpdate(params: RollbackOneUpdateCommandAttributes): Promise<string>;
    rollbackOneUpdateSQL(params: RollbackOneUpdateSQLCommandAttributes): Promise<string>;
    setContexts(params: SetContextsCommandAttributes): Promise<string>;
    setLabels(params: SetLabelsCommandAttributes): Promise<string>;
    /**
     ...
     */
    changelogSync(params: ChangelogSyncCommandAttributes): Promise<string>;
    /**
    ...
    checksBulkSet(params: ChecksBulkSetCommandAttributes): Promise<string>;
    checksCopy(params: ChecksCopyCommandAttributes): Promise<string>;
    checksCreate(params: ChecksCreateCommandAttributes): Promise<string>;
    checksCustomize(params: ChecksCustomizeCommandAttributes): Promise<string>;
    checksDelete(params: ChecksDeleteCommandAttributes): Promise<string>;
    checksDisable(params: ChecksDisableCommandAttributes): Promise<string>;
    checksEnable(params: ChecksEnableCommandAttributes): Promise<string>;
    checksReset(params: ChecksResetCommandAttributes): Promise<string>;
    checksRun(params: ChecksRunCommandAttributes): Promise<string>;
    checksShow(params: ChecksShowCommandAttributes): Promise<string>;
    /**
     ...
     */
    dbclHistory(params: DbclHistoryCommandAttributes): Promise<string>;
    /**
    ...
    executeSql(params: ExecuteSqlCommandAttributes): Promise<string>;
    flow(params: FlowCommandAttributes): Promise<string>;
    init(params: InitCommandAttributes): Promise<string>;
    private stringifyParams;
    private getPositionalArgumentsAndCommandString;
    private getSubstitutionArguments;
