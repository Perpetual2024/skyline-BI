...
var POSTGRESQL_DEFAULT_CONFIG = {
  ...
  username: 'postgres',
  password: '',
  classpath: /*#__PURE__*/join(__dirname, 'drivers/postgresql-42.4.2.jar')
};
...
var Logger = /*#__PURE__*/function () {
  ...
  _proto._info = function _info(message) {
    var levels = [LiquibaseLogLevels.Info, LiquibaseLogLevels.Severe, LiquibaseLogLevels.Warning];
    if (!this.shouldOperate(levels)) {
      return;
    }
