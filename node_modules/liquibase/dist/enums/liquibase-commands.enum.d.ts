export declare enum LiquibaseCommands {
    ...
    ChecksBulkSet = "checksBulkSet",
    ChecksCopy = "checksCopy",
    ChecksCreate = "checksCreate",
    ChecksCustomize = "checksCustomize",
    ChecksDelete = "checksDelete",
    ChecksDisable = "checksDisable",
    ChecksEnable = "checksEnable",
    ChecksReset = "checksReset",
    ChecksRun = "checksRun",
    ChecksShow = "checksShow",
