...
var Liquibase = /*#__PURE__*/function () {
  ...
  _proto.checksEnable = function checksEnable(params) {
    return this.run(exports.LiquibaseCommands.ChecksEnable, params);
  };
  _proto.checksReset = function checksReset(params) {
    return this.run(exports.LiquibaseCommands.ChecksReset, params);
  };
  _proto.checksRun = function checksRun(params) {
    return this.run(exports.LiquibaseCommands.ChecksRun, params);
  };
  _proto.checksShow = function checksShow(params) {
    return this.run(exports.LiquibaseCommands.ChecksShow, params);
  }
  /**
  ...
  _proto.connect = function connect() {
    return this.run(exports.LiquibaseCommands.Connect);
  }
  /**
   ...
   */;
  _proto.dbclHistory = function dbclHistory(params) {
    return this.run(exports.LiquibaseCommands.DbclHistory, params);
  }
  /**
  ...
  _proto.executeSql = function executeSql(params) {
    return this.run(exports.LiquibaseCommands.ExecuteSql, params);
  };
  _proto.flow = function flow(params) {
    return this.run(exports.LiquibaseCommands.Flow, params);
  };
  _proto.init = function init(params) {
    return this.run(exports.LiquibaseCommands.Init, params);
  };
  _proto.stringifyParams = function stringifyParams(action, commandParameters) {
    ...
    var _this$getPositionalAr = this.getPositionalArgumentsAndCommandString(commandParameters, commandAcceptsPropertyAsPositionalArgument),
      positionalArguments = _this$getPositionalAr.positionalArguments,
      commandString = _this$getPositionalAr.commandString;
    var substitutionArguments = this.getSubstitutionArguments(commandParameters);
    return positionalArguments + " " + commandString + " " + substitutionArguments;
  };
  _proto.getPositionalArgumentsAndCommandString = function getPositionalArgumentsAndCommandString(commandParameters, commandAcceptsPropertyAsPositionalArgument) {
    var commandString = '';
  ...
  _proto.getSubstitutionArguments = function getSubstitutionArguments(_ref) {
    var substitutionParams = _ref.substitutionParams;
    var substitutionArguments = '';
    if (!substitutionParams) {
      return substitutionArguments;
    }
    for (var _i = 0, _Object$keys = Object.keys(substitutionParams); _i < _Object$keys.length; _i++) {
